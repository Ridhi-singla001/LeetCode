...
<ul>
	<li><code>1 &lt;= word1.length, word2.length &lt;= 10<sup style="">3</sup></code></li>
	<li><code>1 &lt;= word1[i].length, word2[i].length &lt;= 10<sup style="">3</sup></code></li>
	<li><code>1 &lt;= sum(word1[i].length), sum(word2[i].length) &lt;= 10<sup style="">3</sup></code></li>
